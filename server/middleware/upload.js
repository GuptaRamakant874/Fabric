...
// Ensure upload directory exists, with deployment override support
const uploadDir = process.env.UPLOAD_DIR || process.env.UPLOAD_PATH || path.join(__dirname, '../uploads');
